    ...
    public class ProductApiManager : IProductApiService
    {
        ...
        public async Task AddAsync(ProductAdd productAdd)
        {
            ...
            if (!string.IsNullOrWhiteSpace(token))
            {
                ...
                var responseMessage = await httpClient.PostAsync("http://localhost:48824/api/products", stringContent);
            }
        }
        ...
        public async Task DeleteAsync(int id)
        {
            ...
            if (!string.IsNullOrWhiteSpace(token)){
                ...
                await httpClient.DeleteAsync($"http://localhost:48824/api/products/{id}");
        ...
        public async Task<List<ProductList>> GetAllAsync()
        {
            ...
            if (!string.IsNullOrWhiteSpace(token))
            {
                ...
                var responseMessage = await httpClient.GetAsync("http://localhost:48824/api/products");
        ...
        public async Task<ProductList> GetByIdAsync(int id)
        {
            ...
            if (!string.IsNullOrWhiteSpace(token))
            {
                ...
                var responseMessage = await httpClient.GetAsync($"http://localhost:48824/api/products/{id}");
        ...
        public async Task UpdateAsync(ProductList productList)
        {
            ...
            if (!string.IsNullOrWhiteSpace(token))
            {
                ...
                var stringContent = new StringContent(jsonData,Encoding.UTF8,"application/json");
                await httpClient.PutAsync("http://localhost:48824/api/products", stringContent);
            }
